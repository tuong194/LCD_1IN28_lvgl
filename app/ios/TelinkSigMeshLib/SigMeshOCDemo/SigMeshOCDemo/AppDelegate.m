...
- (void)addMoreCompositionData {
    ...
    DeviceTypeModel *model_8278_CT = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_8278_CT.value];
    DeviceTypeModel *model_8269_CT = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_8269_CT.value];
    DeviceTypeModel *model_9518_CT = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_9518_CT.value];
    ...
    DeviceTypeModel *model_8278_HSL = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_8278_HSL.value];
    DeviceTypeModel *model_8269_HSL = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_8269_HSL.value];
    DeviceTypeModel *model_9518_HSL = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_9518_HSL.value];
    ...
    DeviceTypeModel *model_8278_Panel = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_8278_Panel.value];
    DeviceTypeModel *model_8269_Panel = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_8269_Panel.value];
    DeviceTypeModel *model_9518_Panel = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_9518_Panel.value];
    ...
    DeviceTypeModel *model_8278_LPN = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_8278_LPN.value];
    DeviceTypeModel *model_8269_LPN = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_8269_LPN.value];
    DeviceTypeModel *model_9518_LPN = [[DeviceTypeModel alloc] initWithCID:kCompanyID PID:telinkPid_9518_LPN.value];
