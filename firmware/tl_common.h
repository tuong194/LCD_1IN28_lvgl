...
#include "common/utility.h"						// add by haiwen
#include "vendor/common/chip_adapt_layer/al.h" 	// add by qifa
#include "application/print/u_printf.h" 		// add by qifa
#include "application/keyboard/keyboard.h"		// (BLE_SRC_TELINK_MESH_EN)
