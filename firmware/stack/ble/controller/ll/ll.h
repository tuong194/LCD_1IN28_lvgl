...
extern _align_4_ ll_data_extension_t  bltData;
...
// by weixiong. // BLE_SRC_TELINK_MESH_EN
typedef int (*blt_update_err_callback_t)(u8 *);	// add by weixiong
u8 			adv_filter_proc(u8 *raw_pkt ,u8 blt_sts);	// add by weixiong
typedef void (*bls_phy_scan_mode_t) (int set_chn);
extern bls_phy_scan_mode_t		bls_phy_scan_mode_cb;
