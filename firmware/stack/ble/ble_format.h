...
typedef struct{
	...
	union{
		rf_adv_head2_t header;	// add by qifa to be compatible
		struct{
			u8 type   :4;
			u8 rfu1   :1;
			u8 chan_sel:1;
	...
	u8	advA[6];			//address
#if (MESH_DLE_MODE == MESH_DLE_MODE_EXTEND_BEAR || EXTENDED_ADV_ENABLE) // for BLE_SRC_TELINK_MESH_EN
