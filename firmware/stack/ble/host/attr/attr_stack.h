...
extern u8 *hid_reportmap_psrc;
extern int hid_reportmap_len;

static inline u8* blt_att_getReportMap()
{
	return hid_reportmap_psrc;
}

static inline int blt_att_getReportMapSize()
{
	return hid_reportmap_len;
}
