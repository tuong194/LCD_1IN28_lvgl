...
#define ATT_PERMISSIONS_READ_AUTHOR			 ATT_PERMISSIONS_AUTHOR_READ	// add by haiwen
#define ATT_PERMISSIONS_WRITE_AUTHOR		 ATT_PERMISSIONS_AUTHOR_WRITE	// add by haiwen
#define ATT_PERMISSIONS_RDWD_AUTHOR			 ATT_PERMISSIONS_AUTHOR_RDWR	// add by haiwen
...
/** @} end of group GATT_Characteristic_Property */
	...
	typedef int (*att_readwrite_callback_t)(void* p); // modify by qifa, to be compatible with single connection SDK, and no need multi-conn now.
