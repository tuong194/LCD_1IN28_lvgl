...
C_SRCS += \
../vendor/lvgl/examples/libs/barcode/lv_example_barcode_1.c 

OBJS += \
./vendor/lvgl/examples/libs/barcode/lv_example_barcode_1.o 

C_DEPS += \
./vendor/lvgl/examples/libs/barcode/lv_example_barcode_1.d 


# Each subdirectory must supply rules for building sources it contributes
vendor/lvgl/examples/libs/barcode/%.o: ../vendor/lvgl/examples/libs/barcode/%.c
	@echo 'Building file: $<'
