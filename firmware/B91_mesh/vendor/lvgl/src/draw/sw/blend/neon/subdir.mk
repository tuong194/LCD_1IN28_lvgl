...
S_UPPER_SRCS += \
../vendor/lvgl/src/draw/sw/blend/neon/lv_blend_neon.S 

OBJS += \
./vendor/lvgl/src/draw/sw/blend/neon/lv_blend_neon.o 

S_UPPER_DEPS += \
./vendor/lvgl/src/draw/sw/blend/neon/lv_blend_neon.d 


# Each subdirectory must supply rules for building sources it contributes
vendor/lvgl/src/draw/sw/blend/neon/%.o: ../vendor/lvgl/src/draw/sw/blend/neon/%.S
	@echo 'Building file: $<'
