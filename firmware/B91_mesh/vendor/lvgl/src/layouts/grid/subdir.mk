...
C_SRCS += \
../vendor/lvgl/src/layouts/grid/lv_grid.c 

OBJS += \
./vendor/lvgl/src/layouts/grid/lv_grid.o 

C_DEPS += \
./vendor/lvgl/src/layouts/grid/lv_grid.d 


# Each subdirectory must supply rules for building sources it contributes
vendor/lvgl/src/layouts/grid/%.o: ../vendor/lvgl/src/layouts/grid/%.c
	@echo 'Building file: $<'
