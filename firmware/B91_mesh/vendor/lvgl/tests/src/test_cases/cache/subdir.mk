...
C_SRCS += \
../vendor/lvgl/tests/src/test_cases/cache/test_cache.c 

OBJS += \
./vendor/lvgl/tests/src/test_cases/cache/test_cache.o 

C_DEPS += \
./vendor/lvgl/tests/src/test_cases/cache/test_cache.d 


# Each subdirectory must supply rules for building sources it contributes
vendor/lvgl/tests/src/test_cases/cache/%.o: ../vendor/lvgl/tests/src/test_cases/cache/%.c
	@echo 'Building file: $<'
