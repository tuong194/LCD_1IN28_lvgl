...
C_SRCS += \
../vendor/lvgl/tests/makefile_uefi/test.c 

OBJS += \
./vendor/lvgl/tests/makefile_uefi/test.o 

C_DEPS += \
./vendor/lvgl/tests/makefile_uefi/test.d 


# Each subdirectory must supply rules for building sources it contributes
vendor/lvgl/tests/makefile_uefi/%.o: ../vendor/lvgl/tests/makefile_uefi/%.c
	@echo 'Building file: $<'
