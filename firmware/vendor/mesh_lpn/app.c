...
_attribute_ram_code_ void user_init_deepRetn(void)
{
	...
	if((BLS_LINK_STATE_ADV == blc_ll_getCurrentState()) && is_friend_ship_link_ok_lpn() && (!my_fifo_get(&mesh_adv_cmd_fifo)) && ( (0 == fri_ship_proc_lpn.poll_tick) || clock_time_exceed(fri_ship_proc_lpn.poll_tick, get_lpn_poll_interval_ms()*1000/2)) &&
