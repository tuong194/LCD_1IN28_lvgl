...
/**
 * @brief       This function server to check wether the address is gatt master's unicast address or not.
...
/**
 * @brief       This function server to check wether destination of network PDU is in proxy whitelist, the network PDU will report to corresponding connection handle in mesh_nw_pdu_report_to_gatt().
