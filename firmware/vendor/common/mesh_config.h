...
#define AUDIO_MESH_EN					0	// if CODEC_ALGORITHM_SEL select CODEC_ALGORITHM_SBC, please rename libmic_lib2.a to libmic_lib.a to replace the old one.
		#if AUDIO_MESH_EN
...
#define FW_START_BY_LEGACY_BOOTLOADER_EN   0	// for dual mode
    #else
#define FW_START_BY_LEGACY_BOOTLOADER_EN   1	// for dual mode
    #endif
