...
#define	BLC_PM_DEEP_RETENTION_MODE_EN		1
	...
	#define _attribute_data_retention_force_   	__attribute__((section(".retention_data"))) // some variate of "data" which just be read once without being write may be optimized to "rodata". 
#endif
