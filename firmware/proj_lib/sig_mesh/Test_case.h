...
// SAR config models
	...
	MESH_CL_SAR_BV_02_0C = 0x04180200,

// large composition data models
	MESH_CL_LCD_LCMP_BV_01_0C = 0x04190100,
	
// models metadata procedures
	MESH_CL_LCD_MMD_BV_01_0C = 0x041a0101,

//solicitation PDU RPL configuration models
	MESH_CL_SPRL_BV_01_0C = 0x041b0101,
...
void gw_ini_pts_test_case_cmd(u8 *par, int par_len);
