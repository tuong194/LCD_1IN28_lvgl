 ...
 * @return      0: success. -1 decode error; -2: source adress is self. -3: cache err,eg:the sequence number in the cache is greater than or equal to the sequence number in the received packet .
 * @note        
 */
