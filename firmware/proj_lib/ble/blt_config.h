...
#else
#define AUTO_ADAPT_MAC_ADDR_TO_FLASH_TYPE_EN    ((CFG_SECTOR_ADR_MAC_CODE == CFG_ADR_MAC_512K_FLASH)||(CFG_SECTOR_ADR_MAC_CODE == CFG_ADR_MAC_1M_FLASH)||(CFG_SECTOR_ADR_MAC_CODE == CFG_ADR_MAC_2M_FLASH))
#endif
...
#if(MCU_CORE_TYPE == MCU_CORE_9518)
#if (FLASH_PLUS_ENABLE == 0) // 1 Mbyte flash
...
#else // (FLASH_PLUS_ENABLE == 1) // 2 Mbyte flash
	#if FIRMWARE_SIZE_EXCEED_512K_EN
/* Flash adr 0x00000 ~ 0x0ffff(FW_START_BY_BOOTLOADER_ADDR)  is bootloader firmware area*/
/* Flash adr 0x10000 ~ 0xe7fff  is firmware area*/
#define 		FLASH_ADR_AREA_FIRMWARE_END	0xe8000 // (0xe8000 - 0x10000) = 864K  
/* Flash adr 0xe8000 ~ 0x1bffff  is new firmware store area for OTA*/
#define			FLASH_ADR_AREA_1_START		0x1c0000 // need to be 0xe0000 for flash protection.
#define			FLASH_ADR_MESH_KEY			0x1c0000
#define			FLASH_ADR_MD_CFG_S			0x1c1000
#define			FLASH_ADR_MD_HEALTH			0x1c2000
#define			FLASH_ADR_MD_G_ONOFF_LEVEL	0x1c3000
#define			FLASH_ADR_MD_TIME_SCHEDULE	0x1c4000
#define			FLASH_ADR_MD_LIGHTNESS		0x1c5000 // share with power level
#define			FLASH_ADR_MD_LIGHT_CTL		0x1c6000
#define			FLASH_ADR_MD_LIGHT_LC		0x1c7000
#define			FLASH_ADR_MD_SCENE			0x1c8000
#define 		FLASH_ADR_MD_SENSOR		    0x1c9000
#define 		FLASH_ADR_PROVISION_CFG_S	0x1ca000
#define			FLASH_ADR_MD_LIGHT_HSL		0x1cb000 // cps before V23
#define			FLASH_ADR_MD_VD_LIGHT		0x1cc000
#define			FLASH_ADR_MD_G_POWER_ONOFF	0x1cd000
#define			FLASH_ADR_FRIEND_SHIP		0x1ce000 // backup both FLASH_ADR_MISC and FLASH_ADR_VC_NODE_INFO(gateway) temporarily
#define			FLASH_ADR_MD_PROPERTY		0x1cf000 // just test
#define			FLASH_ADR_MD_DF_SBR			0x1cf000
#define			FLASH_ADR_AREA_1_END		0x1d0000

#define			FLASH_ADR_AREA_2_START		0x1d0000
#define			FLASH_ADR_MISC				0x1d0000 // should be located at the last 64K for future flash protect function.
#define			FLASH_ADR_RESET_CNT			0x1d1000 // should be located at the last 64K for future flash protect function.
#define			FLASH_ADR_SW_LEVEL			0x1d2000 // should be located at the last 64K for future flash protect function.
#define			FLASH_ADR_MD_MISC_PAR		0x1d3000 // SDK type is 0xFD000 for B91m
#define			FLASH_ADR_MD_MESH_OTA		0x1d4000
#if (__PROJECT_MESH_PRO__ || __PROJECT_MESH_GW_NODE__)
#define 		FLASH_ADR_VC_NODE_INFO		0x1d5000	//
#define 		FLASH_ADR_VC_NODE_INFO_END	0x1d6000
#endif
#define			FLASH_ADR_AREA_2_END		0x1d6000


/*******vendor define here, from 0x1f0000 to 0x1f7fff
vendor use from 0x1f0000 to 0x1f7fff should be better, because telink may use 0xFB000,0xFC000 later.
********************************************/
#if(AIS_ENABLE)
#define 		FLASH_ADR_THREE_PARA_ADR	0x1f0000
#define         FLASH_ADR_THREE_PARA_ADR_0x100_0xF00 //please refer to "FLASH_ADR_EDCH_PARA"
	#if(MESH_USER_DEFINE_MODE == MESH_TAIBAI_ENABLE)
#define DU_STORE_ADR						0x1f1000
#define DU_OTA_REBOOT_ADR					0x1f2000
	#elif (ALI_MD_TIME_EN)
#define 		FLASH_ADR_VD_TIME_INFO		0x1f1000
    #endif
#elif(DUAL_MODE_WITH_TLK_MESH_EN)
#define			FLASH_ADR_DUAL_MODE_4K		0x1f0000 // backup dual mode 4K firmware
#elif(LLSYNC_ENABLE)
#define			FLASH_ADR_THREE_PARA_ADR	0x1f0000
#elif (CERTIFY_BASE_ENABLE)
#define 		FLASH_ADR_CERTIFY_ADR		0x1f0000 // we will burn in an 4k bin
#endif


#define			FLASH_ADR_PAR_USER_MAX		0x1f8000 // not include 0x1f8000
// reserve for B92 secure boot:    0x1f8000~0x1fbfff
//#define		FLASH_ADR_MESH_TYPE_FLAG	0x1fd000	// don't change, must same with telink mesh SDK
//------------------------------------------0x1fe000 // is CFG_ADR_CALIBRATION
//------------------------------------------0x1ff000 // is CFG_ADR_MAC

#if ((FW_START_BY_BOOTLOADER_EN || __PROJECT_BOOTLOADER__) && PINGPONG_OTA_DISABLE)
#define FW_START_BY_BOOTLOADER_ADDR     	(0x10000)   // ADDR_FLASH_PRODUCT_IMG
#define OTA_PROGRAM_BOOTADDR_USER           (FLASH_ADR_AREA_FIRMWARE_END)   // ADDR_FLASH_OTA_IMG
#define FW_SIZE_MAX_USER_K     	            ((OTA_PROGRAM_BOOTADDR_USER - FW_START_BY_BOOTLOADER_ADDR)/1024)       // not include firmware offset
#define FLASH_ADR_UPDATE_NEW_FW     		(OTA_PROGRAM_BOOTADDR_USER)
#endif
	#else // FIRMWARE_SIZE_EXCEED_512K_EN == 0
#error to define 508k firmware flash map
	#endif /*end of (FIRMWARE_SIZE_EXCEED_512K_EN == 1)*/
#endif /*end of (FLASH_PLUS_ENABLE == 1)*/
#endif /*end of (MCU_CORE_9518)*/

#if 1// common
#if (FLASH_PLUS_ENABLE && (0 == DUAL_MESH_ZB_BL_EN) && (0 == DUAL_MESH_SIG_PVT_EN))
	#if FLASH_PLUS_ENABLE
#define			FLASH_ADR_MESH_TYPE_FLAG	0x1FD000 // don't change, must same with other SDK
	#else
#define			FLASH_ADR_MESH_TYPE_FLAG	0xFD000	 // don't change, must same with other SDK
	#endif
#endif
